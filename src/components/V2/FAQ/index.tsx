      ...
      <div className="container">
        ...
        className="mx-auto max-w-[700px]">
          <div className="mb-8 flex flex-col items-center justify-center gap-4 md:mb-12">
            <button className="rounded-[14px] bg-[#FFFFFF] p-5 text-[#787878] shadow-[0px_12px_42px_-4px_#18274B1F,_0px_8px_18px_-6px_#18274B1F]">
              FAQ
            </button>
            <h2 className="text-center text-[32px] font-semibold text-[#1A1A2E] md:text-[48px]">
            ...
            {faqKeys.map((key) => (
              ...
              >
                ...
                <Accordion.Content className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down">
                  <p className="max-w-[98%] pb-6 pr-0 text-[16px] leading-[180%] text-[#6B7280] md:pb-8 md:pr-20 md:text-[20px]">
